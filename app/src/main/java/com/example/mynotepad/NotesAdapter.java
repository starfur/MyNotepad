...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.viewHolder> {
    ...
    public NotesAdapter.viewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.textlist, viewGroup, false);
    ...
    public void showDialog(final int pos) {
        ...
        title = (EditText) dialog.findViewById(R.id.baslik);
        des = (EditText) dialog.findViewById(R.id.icerik);
